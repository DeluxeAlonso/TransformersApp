...
extension UIView {
    ...
    func fillSuperview(padding: UIEdgeInsets = .zero) {
        ...
        let superviewBottomAnchor: NSLayoutYAxisAnchor
        let superviewLeadingAnchor: NSLayoutXAxisAnchor
        let superviewTrailingAnchor: NSLayoutXAxisAnchor
        ...
        if #available(iOS 11.0, *) {
            ...
            superviewLeadingAnchor = superview.safeAreaLayoutGuide.leadingAnchor
            superviewTrailingAnchor = superview.safeAreaLayoutGuide.trailingAnchor
        } else {
            superviewTopAnchor = superview.topAnchor
            superviewBottomAnchor = superview.bottomAnchor
            superviewLeadingAnchor = superview.leadingAnchor
            superviewTrailingAnchor = superview.trailingAnchor
        }
